#### The follwoing is the example of associative array

- Question3 :
- Take an example of Associatve array, Explain its funtionality
```
module associative_array_example;
  ...
  initial begin
    ...
    array.delete();
    $display("After deleting array - size = %0d of array", array.size());
  end
endmodule
```
